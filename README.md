...
- [Automated Wildlife Classifier](https://github.com/KrisKlip/Automated-Wildlife-Classifier) - Complete pipeline for camera trap image processing using MegaDetector V6 and PytorchWildlife for species detection and classification.
